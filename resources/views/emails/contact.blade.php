                                            ...
                                            <table align="center" border="0" cellpadding="0" cellspacing="0"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td style="width:72px;">
                                                            <img
                                                                src="https://regiamedik.com/logo.png"
                                                                alt="Regia Medi-K Logo"
                                                                style="width: 120px;"
                                                            >
                                                        </td>
                                                    </tr>
                                    ...
                                    <tr>
                                        <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                            <div
                                                ...
                                                <p>Alguien se ha puesto en contacto a través del sitio web <a style="color: " href="{{ env('APP_URL') }}">regiamedik.com</a>. A continuación los detalles del nuevo mensaje.</p>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
