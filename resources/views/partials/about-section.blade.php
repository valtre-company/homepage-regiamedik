...
<section class="st-about-wrap" id="acerca-de">
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-5 wow fadeInRight" data-wow-duration="0.8s" data-wow-delay="0.2s" style="visibility: visible; animation-duration: 0.8s; animation-delay: 0.2s; animation-name: fadeInRight;">
        <div class="st-shedule-wrap">
          <div class="st-shedule">
            <h2 class="st-shedule-title">Horarios</h2>
            <ul class="st-shedule-list">
              <li>
                <div class="st-shedule-left">Lunes a Jueves</div>
            ...
            <div class="st-call st-style1">
              ...
              <div class="st-call-text">
                ...
                <div class="st-call-number">{{ env('PHONE_NUMBER') }}</div>
              </div>
            </div>
          </div>
        </div>
