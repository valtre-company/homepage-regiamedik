            ...
            <ul class="st-footer-contact-list st-mp0">
              <li class="mb-0">
                <p class="d-block">
                  ...
                  <span class="font-weight-normal">{{ env('EMAIL') }}</span>
                </p>
              </li>
              <li class="flex-column">
                <p class="d-block">
                    ...
                    <span class="font-weight-normal">Tel. {{ env('PHONE_NUMBER') }}</span>                    
                  </span>
                </p>
                <p class="d-block">                  
                  ...
                  <span class="font-weight-normal">WhatsApp: {{ env('WHATSAPP_WITHOUT_CODE') }}</span>
                </p>                  
              </li>
            </ul>
          </div>
