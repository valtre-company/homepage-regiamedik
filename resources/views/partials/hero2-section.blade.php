<div class="st-hero-wrap st-color1 overflow-hidden">
	...
	<div class="st-slider st-style1 st-hero-slider1" id="home">
		<div class="slick-container" data-autoplay="1" data-loop="1" data-speed="800" data-autoplay-timeout="1000" data-center="0" data-slides-per-view="1" data-fade-slide="1">
			<div class="slick-wrapper slick-initialized slick-slider slick-dotted"><div class="slick-list draggable"><div class="slick-track" style="opacity: 1; width: 1740px;"><div class="slick-slide slick-current slick-active" data-slick-index="0" aria-hidden="false" style="width: 580px; position: relative; left: 0px; top: 0px; z-index: 1000; opacity: 1; transition: opacity 800ms ease 0s;" role="tabpanel" id="slick-slide00" tabindex="-1" aria-describedby="slick-slide-control00"><div><div class="slick-slide-in" style="width: 100%; display: inline-block;">
					<div class="st-hero-img">
						<img src="{{ asset('assets/images/hero-img2.png') }}" alt="Hero img">
					</div>
				</div></div></div><div class="slick-slide" data-slick-index="1" aria-hidden="true" style="width: 580px; position: relative; left: -580px; top: 0px; z-index: 998; opacity: 0; transition: opacity 800ms ease 0s;" role="tabpanel" id="slick-slide01" tabindex="-1" aria-describedby="slick-slide-control01"><div><div class="slick-slide-in" style="width: 100%; display: inline-block;">
					<div class="st-hero-img">
						<img src="{{ asset('assets/images/hero-img2.png') }}" alt="Hero img">
					</div>
				</div></div></div><div class="slick-slide" data-slick-index="2" aria-hidden="true" style="width: 580px; position: relative; left: -1160px; top: 0px; z-index: 998; opacity: 0; transition: opacity 800ms ease 0s;" role="tabpanel" id="slick-slide02" tabindex="-1" aria-describedby="slick-slide-control02"><div><div class="slick-slide-in" style="width: 100%; display: inline-block;">
					<div class="st-hero-img">
						<img src="{{ asset('assets/images/hero-img2.png') }}" alt="Hero img">
					</div>
				</div></div></div></div></div></div>
		</div><!-- .slick-container -->
		<div class="pagination st-style1 container d-none"><ul class="slick-dots" role="tablist" style="display: flex;"><li class="slick-active" role="presentation"><button type="button" role="tab" id="slick-slide-control00" aria-controls="slick-slide00" aria-label="1 of 3" tabindex="-1">1</button></li><li role="presentation" class=""><button type="button" role="tab" id="slick-slide-control01" aria-controls="slick-slide01" aria-label="2 of 3" tabindex="-1">2</button></li><li role="presentation" class=""><button type="button" role="tab" id="slick-slide-control02" aria-controls="slick-slide02" aria-label="3 of 3" tabindex="0" aria-selected="true">3</button></li></ul></div> <!-- If dont need Pagination then add class .st-hidden -->
